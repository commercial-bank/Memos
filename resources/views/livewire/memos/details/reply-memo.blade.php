<div class="fixed inset-0 bg-gray-600 bg-opacity-75 overflow-y-auto h-full w-full" style="display: {{ $replyModal ? 'block' : 'none' }};">
    @if ($replyModal) {{-- Ne rend le contenu du modal que s'il est ouvert --}}
